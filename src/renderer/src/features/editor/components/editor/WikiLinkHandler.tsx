...
export function useWikiLinkHandler({
  ...
  onOpenLink,
  locale
}: WikiLinkHandlerProps) {
  const [tooltip, setTooltip] = useState<WikiLinkTooltip | null>(null)
...
export function WikiLinkTooltip({ tooltip }: { tooltip: WikiLinkTooltip | null }) {
